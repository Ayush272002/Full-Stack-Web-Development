...
setInterval(() => console.log("Hello World after 2 sec"), 2000);
// -------------------------------
...
setTimeout(function () {
  console.log("This function will be executed after 3 sec"), 3000;
});
...
const intervalId = setInterval(function () {
  console.log("This function is being excuted");
}, 1000);
